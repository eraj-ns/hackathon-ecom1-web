import bedroomimage1 from '@/app/public/inner.png'
import bedroomimage2 from '@/app/public/Rectangle 25 (1).png'
...
const RoomIspirations = () => {
  return (
    <div>
      <div className="container mx-auto px-4 md:px-6 flex flex-col lg:flex-row bg-[#FCF8F3] gap-4 md:gap-8 p-4 md:p-6 lg:p-12 my-8 rounded-xl bg-white">
        <div className="w-full lg:w-1/3 flex flex-col justify-center space-y-6">
          <h2 className="text-3xl lg:text-4xl xl:text-5xl font-bold text-center lg:text-left text-black">
        ...
        <div className="flex flex-col sm:flex-row gap-6 lg:flex-grow">
          ...
          <div className="w-full sm:w-1/2 space-y-6">
            ...
            <div className='flex items-center justify-center space-x-6 py-4'>
                <div className="text-2xl cursor-pointer hover:text-amber-500 transition-colors">
              <FaCircleArrowLeft />
              </div>
